      ...
      <ul class="category">
        <li>
          <button
            ...
            v-if="keyword === '운동선수'"
            @click="changeKeyword('운동선수'), changecategory(1)"
          >
            운동선수
          </button>
          <button v-else @click="changeKeyword('운동선수'), changecategory(1)">
            운동선수
          </button>
        </li>
        <li>
          <button
            class="category_color"
            v-if="keyword === '드 라 마'"
            @click="changeKeyword('드 라 마'), changecategory(2)"
          >
            드 라 마
          </button>
          <button v-else @click="changeKeyword('드 라 마'), changecategory(2)">
            드 라 마
          </button>
        </li>
        <li>
          <button
            class="category_color"
            v-if="keyword === '영    화'"
            @click="changeKeyword('영    화'), changecategory(3)"
          >
            영 화
          </button>
          <button v-else @click="changeKeyword('영    화'), changecategory(3)">
            영 화
          </button>
        </li>
        <li>
          <button
            class="category_color"
            v-if="keyword === '연 예 인'"
            @click="changeKeyword('연 예 인'), changecategory(4)"
          >
            연 예 인
          </button>
          <button v-else @click="changeKeyword('연 예 인'), changecategory(4)">
            연 예 인
          </button>
        </li>
      </ul>
          ...
          <label class="card-wrap">
            ...
            <div class="card">
              ...
              <div class="back card-face">
                ...
                <footer class="social">
                  <button
                    class="btn btn__phone"
                    @click="openYoutubeModal(cardfront[0].name)"
                  ></button>
                  <button
                    class="btn btn__email"
                    @click="openTwitterModal(cardfront[0].name)"
                  ></button>
                </footer>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="back card-face">
                ...
                <footer class="social">
                  <button
                    class="btn btn__phone"
                    @click="openYoutubeModal(cardfront[1].name)"
                  ></button>
                  <button
                    class="btn btn__email"
                    @click="openTwitterModal(cardfront[1].name)"
                  ></button>
                </footer>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="back card-face">
                ...
                <footer class="social">
                  <button
                    class="btn btn__phone"
                    @click="openYoutubeModal(cardfront[2].name)"
                  ></button>
                  <button
                    class="btn btn__email"
                    @click="openTwitterModal(cardfront[2].name)"
                  ></button>
                </footer>
              </div>
            </div>
